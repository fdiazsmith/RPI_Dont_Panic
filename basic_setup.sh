...
cat >$MOTD <<EOL
#create a hidden file and and alias bashrc to execute it
echo "create a hidden file and and alias bashrc to execute it"
echo "mtestcreate a hidden file and and alias bashrc to execute it"
EOL
